...
class ImageWidgetHayvan extends StatefulWidget {



  const ImageWidgetHayvan({Key? key}) : super(key: key);

  @override
  State<ImageWidgetHayvan> createState() => _ImageWidgetHayvanState();
}

class _ImageWidgetHayvanState extends State<ImageWidgetHayvan> {

  //final _firestore = FirebaseFirestore.instance;
  final _firestore_filter = FirebaseFirestore.instance.collection("wallpaper").where("tag",arrayContains: "h");
