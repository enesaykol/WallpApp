...
class ImageWidgetKulturel extends StatefulWidget {



  const ImageWidgetKulturel({Key? key}) : super(key: key);

  @override
  State<ImageWidgetKulturel> createState() => _ImageWidgetKulturelState();
}

class _ImageWidgetKulturelState extends State<ImageWidgetKulturel> {

  //final _firestore = FirebaseFirestore.instance;
  final _firestore_filter = FirebaseFirestore.instance.collection("wallpaper").where("tag",arrayContains: "k");
