...
class ImageWidgetYiyecekIcecek extends StatefulWidget {



  const ImageWidgetYiyecekIcecek({Key? key}) : super(key: key);

  @override
  State<ImageWidgetYiyecekIcecek> createState() => _ImageWidgetYiyecekIcecekState();
}

class _ImageWidgetYiyecekIcecekState extends State<ImageWidgetYiyecekIcecek> {

  //final _firestore = FirebaseFirestore.instance;
  final _firestore_filter = FirebaseFirestore.instance.collection("wallpaper").where("tag",arrayContains: "yi");
