...
class ImageWidgetManzara extends StatefulWidget {



  const ImageWidgetManzara({Key? key}) : super(key: key);

  @override
  State<ImageWidgetManzara> createState() => _ImageWidgetManzaraState();
}

class _ImageWidgetManzaraState extends State<ImageWidgetManzara> {

  //final _firestore = FirebaseFirestore.instance;
  final _firestore_filter = FirebaseFirestore.instance.collection("wallpaper").where("tag",arrayContains: "m");
